...
####################################################################
## Kyeongtak Han 5492834
## I add IIADDQ to instr_valid to make IIADDQ validate.
## I add IIADDQ to need_regids and valC as the IADDQ operates on sum of
## constant and register, so make these two component work well. 
####################################################################
...
word d_srcA = [
    D_icode in { IRRMOVQ, IRMMOVQ, IOPQ, IPUSHQ } : D_rA;                           # choose regA
...
word d_dstE = [
    D_icode in { IRRMOVQ, IIRMOVQ, IOPQ, IIADDQ} : D_rB;                                     # choose dstReg
    D_icode in { IPUSHQ, IPOPQ, ICALL, IRET } : RRSP;
...
## Forward into decode stage for valA                                             # forwarding   
word d_valA = [
...
word aluA = [
    ...
    E_icode in { IIRMOVQ, IRMMOVQ, IMRMOVQ, IIADDQ } : E_valC;                             # constants
...
word aluB = [
    E_icode in { IRMMOVQ, IMRMOVQ, IOPQ, ICALL, 
             IPUSHQ, IRET, IPOPQ, IIADDQ } : E_valB;                                   # rB 
...
bool set_cc = (E_icode == IOPQ || E_icode == IIADDQ) &&                                        # add condition flag      
